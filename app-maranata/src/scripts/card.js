const Icons = {
  ...
  master: require('~/assets/cards/stp_card_mastercard.png'),
...
export function getFlagWithNumber(cardnumber) {
...
export const getIconWithFlag = (bandeira) => Icons[bandeira];

export function getIconWithNumber(cardnumber) {
  var cardnumber = cardnumber.replace(/[^0-9]+/g, '');
