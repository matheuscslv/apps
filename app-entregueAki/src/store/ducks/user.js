...
const { Types, Creators } = createActions({
  ...
  getRegisterRequest: [],
  setNewAddressRequest: ['payload'],
  setAddressRequest: ['payload'],
  setDeleteAddressRequest: ['payload']
});
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.SET_NEW_ADDRESS_REQUEST]: state =>
    state.merge({
      loading: true,
    }),
  ...
  [Types.SET_DELETE_ADDRESS_REQUEST]: state =>
    state.merge({
      loading: true,
    }),
